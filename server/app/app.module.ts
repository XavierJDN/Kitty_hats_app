...
@Module({
    ...
    providers: [FsManager, ContractInteractionService, KittyContractManagerService, KittyTokenContractManagerService, KittyTokenMarketContractManagerService,Logger],
})
